...
public class RecyclerViewSoilAdapter extends RecyclerView.Adapter {

    public ArrayList<parameter_soil> datas = null;
    ...
    public RecyclerViewSoilAdapter(ArrayList<parameter_soil> datas) {
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof ItemOneViewHolder) {
            ...
            ((ItemOneViewHolder) viewHolder).img_txt.setText(datas.get(position).getElement_name());
