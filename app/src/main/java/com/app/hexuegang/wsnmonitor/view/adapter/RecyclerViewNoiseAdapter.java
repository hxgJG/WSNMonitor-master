...
public class RecyclerViewNoiseAdapter extends RecyclerView.Adapter {

    public ArrayList<parameter_noise> datas = null;
    ...
    public RecyclerViewNoiseAdapter(ArrayList<parameter_noise> datas) {
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof ItemOneViewHolder) {
            ...
            ((ItemOneViewHolder) viewHolder).img_txt.setText("等效A声级");
            ...
            ((ItemTwoViewHolder) viewHolder).title.setText(datas.get(position).getNoise_name());
        }
    }
