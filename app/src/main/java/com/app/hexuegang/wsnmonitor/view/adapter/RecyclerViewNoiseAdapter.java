...
public class RecyclerViewNoiseAdapter extends BaseRecyclerViewAdapter<ParameterNoise> {


    public RecyclerViewNoiseAdapter(Context context, ArrayList<ParameterNoise> datas) {
        super(context, datas);
    }
    ...
    public class ItemWaterViewHolder extends BaseRecyclerViewHolder{
        ...
        @Override
        public void bindView(final int position, final ParameterNoise pSoil) {
            ...
            img_txt.setText(pSoil.getNoise_name());
