...
public class RecyclerViewWaterAdapter extends RecyclerView.Adapter {

    public ArrayList<parameter_water> datas = null;
    ...
    public RecyclerViewWaterAdapter(ArrayList<parameter_water> datas) {
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof ItemOneViewHolder) {
            ...
            ((ItemOneViewHolder) viewHolder).img_txt.setText(datas.get(position).getName());
            ...
            ((ItemTwoViewHolder) viewHolder).title.setText(datas.get(position).getElement_name());
        }
    }
    ...
    private int getResId(){
        ...
        if(r%2 == 0)
        {
            resId = R.mipmap.icon_water;
        }
        else {
            resId = R.mipmap.icon_water_2;
        }
        return resId;
    }
